...
var app = (function () {
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p, "class", "error svelte-1wbvylk");
    			add_location(p, file$4, 18, 8, 446);
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span0, "class", "form_label svelte-1wbvylk");
    			add_location(span0, file$4, 22, 12, 603);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "id", "name");
    			attr_dev(input0, "placeholder", "Enter your name");
    			attr_dev(input0, "class", "form__input svelte-1wbvylk");
    			add_location(input0, file$4, 23, 12, 654);
    			attr_dev(label0, "for", "name");
    			add_location(label0, file$4, 21, 8, 571);
    			attr_dev(span1, "class", "form_label svelte-1wbvylk");
    			add_location(span1, file$4, 26, 12, 814);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "id", "email");
    			attr_dev(input1, "placeholder", "Enter your email");
    			attr_dev(input1, "class", "form__input svelte-1wbvylk");
    			add_location(input1, file$4, 27, 12, 866);
    			attr_dev(label1, "for", "email");
    			add_location(label1, file$4, 25, 8, 781);
    			attr_dev(button, "class", "action-button");
    			add_location(button, file$4, 29, 8, 996);
    			add_location(form, file$4, 20, 4, 515);
    			attr_dev(section, "class", "form svelte-1wbvylk");
    			add_location(section, file$4, 16, 0, 397);
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	return [name, email, error, handleSubmit, input0_input_handler, input1_input_handler];
    }
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$1, 23, 8, 702);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file$1, 27, 12, 863);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "id", "name");
    			attr_dev(input0, "placeholder", "Enter your name");
    			attr_dev(input0, "class", "form__input");
    			add_location(input0, file$1, 28, 12, 914);
    			attr_dev(label0, "for", "name");
    			add_location(label0, file$1, 26, 8, 831);
    			attr_dev(span1, "class", "form_label svelte-1cgjhix");
    			add_location(span1, file$1, 31, 12, 1088);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "id", "email");
    			attr_dev(input1, "placeholder", "Enter your email");
    			attr_dev(input1, "class", "form__input");
    			add_location(input1, file$1, 32, 12, 1140);
    			attr_dev(label1, "for", "email");
    			add_location(label1, file$1, 30, 8, 1055);
    			attr_dev(button, "class", "action-button");
    			add_location(button, file$1, 34, 8, 1284);
    			add_location(form, file$1, 25, 4, 771);
    			attr_dev(section, "class", "form");
    			add_location(section, file$1, 21, 0, 653);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (53:0) <Modal isOpen={isOpen} modalToggle={modalToggle}>
    function create_default_slot(ctx) {
    	...
    	editform.$on("closeModal", /*closeModal*/ ctx[8]);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(53:0) <Modal isOpen={isOpen} modalToggle={modalToggle}>",
    		ctx
    	});
    ...
    function create_title_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file, 54, 8, 1522);
    			attr_dev(div, "slot", "title");
    			add_location(div, file, 53, 4, 1495);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, p);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 59, 1, 1672);
    			add_location(main, file, 58, 0, 1664);
    		},
    		l: function claim(nodes) {
